...
export default function FloorAperture({ displayWidth, displayHeight, isOutside, floorApertureDistance = 900 }) {
    const label = `Floor Aperture Distance = ${Number(floorApertureDistance) || 900}`;
    return (
        <Group y={displayHeight + 90}>
            {isOutside ? (
                <Group>
                    ...
                    <CenteredText x={-130} y={7} text={label}
                ...
                <Group>
                    ...
                    <CenteredText x={displayWidth + 130} y={7} text={label}
                        fontSize={12} fill="#64748b" fontStyle="normal" />
                </Group>
            )}
        </Group>
